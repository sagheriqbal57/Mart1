...
public class Wishlist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(v -> {
            Intent intent= new Intent(Wishlist.this, MainActivity2.class);
    ...
    private void bottomNavigation()
    {
        ...
        if (homeBtn instanceof LinearLayout) {
            homeBtn.setOnClickListener(v -> startActivity(new Intent(Wishlist.this, MainActivity2.class)));
        }

        if (cartBtn instanceof LinearLayout) {
            cartBtn.setOnClickListener(v -> startActivity(new Intent(Wishlist.this, CartActivity.class)));
        }

        if (profileBtn instanceof LinearLayout) {
            profileBtn.setOnClickListener(v -> startActivity(new Intent(Wishlist.this, Profile.class)));
        }
